...
<div class="col-md-8">
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="<?php echo site_url('invoice/add/?sell'); ?>" class="link-dashboard-stat">
        ...
        <div class="col-md-3">
            <a href="<?php echo site_url('invoice/add/?buy'); ?>" class="link-dashboard-stat">
                <div class="dashboard-stat metro_green none">
                    <div class="details">
        ...
        <div class="col-md-3">
            <a href="<?php echo site_url('invoice/invoice_list'); ?>" class="link-dashboard-stat">
                <div class="dashboard-stat yellow none">
                    <div class="details">
                        <div class="number"><?php lang('fiches'); ?></div>
        ...
        <div class="col-md-3">
            <a href="<?php echo site_url('invoice/invoice_design'); ?>" class="link-dashboard-stat">
                <div class="dashboard-stat yellow none">
                    <div class="details">
                        <div class="number fs-18"><?php lang('invoice design'); ?></div>
                        <div class="desc"><?php lang('custom invoice design space'); ?></div>
                     </div>
                </div> <!-- /.dashboard-stat -->
             </a>
        </div> <!-- /.col-md-3 -->
...
<div class="col-md-4">
	<?php if(get_the_current_user('role') < 3): ?>
        <div class="widget">
            <div class="header">Fatura Listesi Menüleri</div>
            <div class="content">
            <?php
            ...
            $this->db->limit(10);
            $query = $this->db->get('fiches')->result_array();
            ?>
            <?php if($query) : ?>

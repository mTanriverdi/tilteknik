    	...
    	<tr>
        	<td class="">
                ...
                >
                    ...
                    <small class="pull-right <?php if($product['amount'] <= 0):?>text-danger<?php else: ?>text-success<?php endif; ?>">stok: <span class="fs-12"><?php echo get_amount($product['amount']); ?></span></small>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>

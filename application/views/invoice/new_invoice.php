        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="date" class="control-label"><?php lang('Date of Receipt'); ?></label>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <input type="hidden" name="account_id" id="account_id" value="<?php echo $invoice['account_id']; ?>" />

...
<div class="row">
	<div class="col-md-6">
        ...
        <form name="form_product_options" id="form_product_options" action="" method="POST" class="widget">
        	<div class="header"><i class="fa fa-puzzle-piece"></i> Stok yönetimi ve erişim ayarları</div>
        	<div class="content">
            	<div class="note">
        			<small>
                ...
                <div class="form-group">
                    ...
                    <select name="product_cost_price" id="product_cost_price" class="form-control valid">
    ...
    <div class="col-md-6">
        <form name="form_settings" id="form_settings" action="?" method="POST" class="widget validation_2">
            <div class="header"><i class="fa fa-puzzle-piece"></i> Diğer ayarlar</div>
            <div class="content">

                <h5 class="line">Barkod Ayarları</h5>
                <div class="note">

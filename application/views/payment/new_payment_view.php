...
?>
    ...
    <form name="form_new_product" id="form_new_product" action="" method="POST" class="validation widget">
        <div class="header">Yeni Ödeme - <?php if(isset($_GET['get_money'])): ?>
            <?php lang('Get Money'); ?>
        <?php else: ?>
            <?php lang('Give Money'); ?>
        <?php endif; ?></div>
        <div class="content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-prepend input-group">
                                        ...
                                        <input type="text" id="checks_serial_no" name="checks_serial_no" class="form-control  " placeholder="<?php lang('Serial No'); ?>">
                                    </div>
                                </div> <!-- /.form-group --> 
                            </div> <!-- /.col-md-6 -->
                        </div> <!-- /.row -->
            ...
            <div class="text-right">
                ...
                <button class="btn btn-default2"><?php lang('Next'); ?> &raquo;</button>
            </div> <!-- /.text-right -->
        </div> <!-- /.content -->
    </form>

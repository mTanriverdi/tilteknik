...
<form name="form_new_product" id="form_new_product" action="" method="POST" class="validation">
    ...
    <div class="row">
    	<div class="col-md-6">
            <div class="form-group">
                <label for="date" class="control-label  "><?php lang('Payment Date'); ?></label>
        ...
        <div class="col-md-6">
            <div class="form-group openModal-account_list">
                ...
                <label for="account_name" class="control-label  "><?php lang('Account Card'); ?></label>
                <div class="input-prepend input-group">
                    <span class="input-group-addon pointer"><span class="glyphicon glyphicon-text-width"></span></span>
                    <input type="text" id="account_name" name="account_name" class="form-control   pointer required" placeholder="<?php lang('Select Account'); ?>" minlength="3" maxlength="30" value="<?php echo $account['name']; ?>" readonly>
                </div>
            </div> <!-- /.form-group -->
    	</div> <!-- /.col-md-6 -->
    </div> <!-- /.row -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="payment" class="control-label  "><?php lang('Payment'); ?></label>
                <div class="input-prepend input-group">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
                    <input type="text" id="payment" name="payment" class="form-control   required number" placeholder="0.00" maxlength="10" value="<?php echo get_money($invoice['grand_total']); ?>" onkeypress="calc_payment();" onkeyup="calc_payment();">
                </div>
            </div> <!-- /.form-group -->
    	</div> <!-- /.col-md-6 -->
        <div class="col-md-6">
            	...
            	<div class="row">
                	<div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-prepend input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                <input type="text" id="fall_due_on" name="fall_due_on" class="form-control   required datepicker pointer" placeholder="<?php lang('Fall Due On'); ?>" minlength="3" maxlength="50" value="<?php echo $invoice['val_2']; ?>" readonly>
                            </div>
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-md-6 -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="checks_serial_no" class="control-label  "><?php lang('Serial No'); ?></label>
                            <div class="input-prepend input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-text-width"></span></span>
                                <input type="text" id="checks_serial_no" name="checks_serial_no" class="form-control  " placeholder="<?php lang('Serial No'); ?>" value="<?php echo $invoice['val_3']; ?>">
                            </div>
                        </div> <!-- /.form-group --> 
                    </div> <!-- /.col-md-6 -->
                </div> <!-- /.row -->
